...
%
%   [Y,CSI] = heEqualizeCombine(X,CHANEST,NOISEVAR,CFGSU) performs
...
%
%   CFGSU is the format configuration object of type <a href="matlab:help('wlanHESUConfig')">wlanHESUConfig</a> or 
...
validateattributes(cfg,{'wlanHESUConfig','wlanHEMUConfig','heTBSystemConfig','wlanHERecoveryConfig'},{'scalar'},mfilename,'format configuration object');
