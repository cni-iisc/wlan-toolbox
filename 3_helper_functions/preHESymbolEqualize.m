...
%   size Nst-by-Nsym-by-Nr, where Nst represents the number of carriers
%   (frequency domain), Nsym represents the number of symbols (time
%   domain), and Nr represents the number of receiver antennas. It is
%   complex when either X or CHANEST is complex, or is real otherwise.
%
